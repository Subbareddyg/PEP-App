...
<div  class="cars_panel x-hidden">
	<div class="x-panel-header">
		<fmt:message key="splitgroup.screen.level.header.ssg" />
	</div>
	
	<div class="x-panel-body">
		<div class="group-search-area">
			<form name="frmComponentSearch" id="frmComponentSearch" action="" class="SSG-group-validation">
				...
				<td>
					...
					<select name="groupTypeDropDown" id="groupTypeDropDown" disabled="disabled">
						<c:forEach var="groupTypesMap" items="${groupTypesMap}">                                                                                                
	                        <option value="${groupTypesMap.key}"  ${groupTypesMap.key == 'SSG' ? 'selected' : '' }><c:out value="${groupTypesMap.value}"/></option>              
	                    </c:forEach>
					</select>
				</td>
			</tr>
