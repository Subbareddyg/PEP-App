...
@NamedQuery(name="ExternalUser.findUser", query="from ExternalUser b where b.primaryEmail = :email")
public class ExternalUser implements Serializable {
    ...
    public String toString() {
        return "ExternalUser [id=" + id + ", createdBy=" + createdBy
            + ", createdDate=" + createdDate + ", failedLoginAttempts="
            + failedLoginAttempts + ", firstName=" + firstName
            + ", lastLoginDateTime=" + lastLoginDateTime + ", lastName="
            + lastName + ", primaryEmail=" + primaryEmail + ", pwdStatus="
            + pwdStatus + ", supplierPwd=" + supplierPwd + ", updatedBy="
            + updatedBy + ", updatedDate=" + updatedDate + ", pepRole="
            + pepRole + "]";
    }
