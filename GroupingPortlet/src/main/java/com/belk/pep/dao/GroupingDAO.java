...
public interface GroupingDAO {
	 ...
	 *             PEPFetchException
	 */
	CreateGroupDTO getGroupHeaderDetails(String groupId)
			throws PEPFetchException;
	 ...
	 * @return
	 */
	List<GroupAttributeForm> getExistSplitSkuDetails(final String groupId);
	 ...
	 *            groupSearchParent(List<GroupSearchDTO>
	 * @return List<GroupSearchDTO>
	 * 
	 * @throws PEPServiceException
	 *             PEPServiceException
	 ...
	 *             Added By: Cognizant
	 */
	List<GroupSearchDTO> groupSearchParent(
			List<GroupSearchDTO> groupSearchDTOList,
			GroupSearchForm groupSearchForm) throws PEPServiceException,
			PEPPersistencyException;
	 ...
	 *             Added By: Cognizant
	 */
	int groupSearchParentCount(List<GroupSearchDTO> groupSearchDTOList,
			GroupSearchForm groupSearchForm) throws PEPServiceException,
			PEPPersistencyException;
