...
//@NamedQuery(name="BelkUser.findAll", query="SELECT b FROM BelkUser b where LOWER(b.belkId) =:belkId")


@NamedQuery(name="BelkUser.findbelkUser", query="from BelkUser b where LOWER(b.belkId) = ?1")
public class BelkUser implements Serializable {
    ...
    public String toString() {
        return "BelkUser [belkId=" + belkId + ", belkEmail=" + belkEmail
            + ", createdBy=" + createdBy + ", createdDate=" + createdDate
            + ", lastLoginDateTime=" + lastLoginDateTime + ", updatedBy="
