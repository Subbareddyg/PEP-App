...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
	...
	<script type="text/javascript" src="<%=response.encodeURL(request.getContextPath()+"/js/treegridlocal.js")%>"></script>
	...
	<script src="<%=response.encodeURL(request.getContextPath()+"/js/worklist.js")%>"></script>
