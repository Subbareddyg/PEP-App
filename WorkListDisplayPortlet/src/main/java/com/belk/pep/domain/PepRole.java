...
@NamedQueries(
    {@NamedQuery(name="PepRole.findAll", query="SELECT p FROM PepRole p"),
     @NamedQuery(name="PepRole.findRoleDetails", query="from PepRole d where d.pepRoleId = :peproleid")
    }  
)
public class PepRole implements Serializable {
    ...
    public String toString() {
        return "PepRole [pepRoleId=" + pepRoleId + ", accessType=" + accessType
            + ", createdBy=" + createdBy + ", createdDate=" + createdDate
            + ", roleStatus=" + roleStatus + ", updatedBy=" + updatedBy
            + ", updatedDate=" + updatedDate + ", userType=" + userType
            + ", belkUsers=" + belkUsers + ", externalUsers=" + externalUsers
            + "]";
    }
