					...
					win = new Ext.Window({
						...
						buttons: [{
				                ...
				                handler: function(){
									...
									if(btnSel=='#add_return_note_btn'){
										alert("hi btn");
										 notes=$("#returnNoteMessage").val();
										 //$("#returnNotesId").text(notes);
										 document.getElementById("returnNotesId").value= notes;
										// alert("hi btn"+notes);
										 
										
									}
									
									if(btnSel=='#add_sample_note_btn'){
										alert("hi btn"+notes);
												 notes=$("#sampleNotesMessageId").val();
